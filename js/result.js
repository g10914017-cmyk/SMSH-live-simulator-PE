...
window.onload = function () {
  ...
  resultText += getResult(
    "專長",
    scores.興趣,
    "(滿分10)過了三年的青春，不小心錯過了一些認真增進技術的時間跟比賽，之後把獲大學好好成為了不起的選手吧",
    "(滿分10)有的時候會在生活跟練專長之間取捨，準備比賽提升自己的同時，也盡量都有讀到書，也拿到了一些獎項，蠻平衡的",
    "(滿分10)你花了很多時間在精進自己的專長，你對這些熱愛的理解跟體驗已經遠超同齡人了，未來國際的體育舞台就靠你了!",
  );
